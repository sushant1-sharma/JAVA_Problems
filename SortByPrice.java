...
public class SortByPrice {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < splitWords.length; i++) {
            String trimmedValue = splitWords[i].trim();

            if (!trimmedValue.isEmpty() && verifyIsNumber(trimmedValue)) {
                treeMap.put(Integer.valueOf(trimmedValue), stringBuilder.toString());
